"use strict";
const stringEcho = (arg) => arg; //Here it will only work with string type
const stringEchoGeneric = (arg) => arg; //here it can be worked with any type - generic
const isObj = (arg) => {
...
const myState = new stateObject([15]); //here it accepts any of this and 15 is passed to array
